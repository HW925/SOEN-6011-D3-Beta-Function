...
\begin{tikzpicture}[remember picture,overlay]
  ...
  % Centre column
  \PosterBox{28.4}{8.0}{26.8}{16.7}{Problem 7: Quality and Versioning}{
    \centering
    ...
    \begin{minipage}[t]{12.0cm}
      ...
      \texttt{too-many-public-methods} after test expansion. One oversized
      test class was split into three focused classes, restoring
      \textbf{10.00/10} without a global suppression.
    \end{minipage}\hfill
    \begin{minipage}[t]{12.4cm}
      ...
      \textbf{Why 1.0.0:} first stable GUI and numerical contract, recorded by
      repository tag \texttt{v1.0.0} (Semantic Versioning, 2026).
    \end{minipage}
  }

  \PosterBox{28.4}{25.4}{26.8}{14.4}{Problem 7: Debugger Evidence}{
    \centering
    \includegraphics[width=22.5cm]{assets/pdb_crop.jpg}
    \par\vspace{0.24cm}
    \fontsize{14}{17}\selectfont\RaggedRight
    A reproducible \texttt{pdb} session stops inside \texttt{beta\_function},
    inspects $(x,y)=(2,3)$, and steps through finite and domain validation
    before continuing to the known result $1/12$.
  }

  \PosterBox{28.4}{40.5}{26.8}{10.6}{Verified Numerical Contract}{
    \centering
