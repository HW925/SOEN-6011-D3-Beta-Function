...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \PosterBox{1.5}{8.0}{26.1}{27.0}{Final Graphical Interface}{
    \centering
    \includegraphics[width=24.8cm]{assets/gui_accessibility.png}
    \par\vspace{0.35cm}
    \RaggedRight
  ...
  \PosterBox{28.4}{8.0}{26.8}{13.5}{Problem 7: Style and Static Analysis}{
    \centering
    \includegraphics[width=25.5cm]{assets/quality_tools.png}
    \par\vspace{0.3cm}
    \RaggedRight
    Flake8 reports no PEP 8 style violations; Pylint rates the final source
    \textbf{10.00/10}. Both snapshots were generated from version 1.0.0.
  }

  \PosterBox{28.4}{22.2}{26.8}{14.7}{Problem 7: Debugger Evidence}{
    \centering
    \includegraphics[width=25.5cm]{assets/pdb_session.png}
    \par\vspace{0.3cm}
    \RaggedRight
  ...
  \PosterBox{28.4}{37.6}{26.8}{13.5}{Verified Numerical Contract}{
    \centering
    \includegraphics[width=24.0cm]{assets/accuracy_verification.png}
    \par\vspace{0.18cm}
  ...
  \PosterBox{56.0}{32.4}{26.6}{18.7}{Problem 8: PyUnit Test Suite}{
    \centering
    \includegraphics[width=25.3cm]{assets/unit_tests.png}
    \par\vspace{0.25cm}
    \RaggedRight
